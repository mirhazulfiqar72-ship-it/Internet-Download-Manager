...
CATEGORIES={'Programs':('exe msi msix appx apk xapk bat cmd com dll jar deb rpm dmg iso run ps1 sh sys bin','Program'),
 ...
 'Documents':('pdf doc docx docm xls xlsx xlsm ppt pptx pptm txt csv rtf odt epub ods odp','docoments'),
 'Archives':('zip rar 7z gz tar bz2 xz tgz','Compressed'),
